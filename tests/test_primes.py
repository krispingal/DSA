...
from src.dsa.algorithms.prime_sieve import Solution as PrimeSieve
...
class TestPrimeSieve:
    ...
    @pytest.mark.parametrize("actual, expected_length, msg", [
        (100, 25, "Primes till 20"),
        (1000, 168, "Primes till 1000")
    ])
